...
<button class="cta-button elite-button" id="elite-button">
Get Elite Service
</button>
</div>
</div>
...
checkoutButton.addEventListener('click', async () => {
    try {
        ...
        if (isDevelopment) {
            alert('Development mode: Stripe checkout would normally redirect to payment page');
            // Simulate successful payment - go directly to success page
            window.location.href = '/success-dev.html';
            return;
        }
        
        const baseUrl = 'https://proofbound-stripe.netlify.app';
        const successUrl = 'https://proofbound.com/success.html';
        const cancelUrl = 'https://proofbound.com/cancel.html';
...
eliteButton.addEventListener('click', () => {
    ...
    if (isDevelopment) {
        // Link to local React app
        window.open('http://localhost:5173', '_blank');
    } else {
        // Link to production app
        window.open('https://app.proofbound.com', '_blank');
    }
});
